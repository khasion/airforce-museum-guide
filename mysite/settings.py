...
SECRET_KEY = 'django-insecure-*by6)n8lp4+lyzdd51$!p2^=q7^43^#in_0-yt8@cms#j_$ox9'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = os.path.join(BASE_DIR, 'mouseio/static'),
